...
<div class="slider-area">
  ...
  if( $basicpost->have_posts() ){
    while ($basicpost->have_posts() ){
        ...
        ?>
        <div class="single-slider slider-height-1 bg-img" style="background-image:url(<?php echo get_template_directory_uri(); ?>/assets/img/slider/slider-1.jpg);">
            <div class="container">
                <div class="row">
                ...
                <div class="slider-single-img slider-animated-1">
                    <img class="animated" src="<?php echo get_template_directory_uri(); ?>/assets/img/slider/single-slide-1.png" alt="">
                </div>
            </div>
        </div>
    <?php }
        ...
        <div class="row no-gutters choose-negative-mrg">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="single-choose-us choose-bg-yellow">
                    <div class="choose-img">
                        <img class="animated" src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-img/service-2.png" alt="">
                    </div>
                    <div class="choose-content">
                        <h3>Scholarship Facility</h3>
                        <p>magna aliqua. Ut enim ad minim veniam conse ctetur adipisicing elit, sed do exercitation. </p>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="single-choose-us choose-bg-blue">
                    <div class="choose-img">
                        <img class="animated" src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-img/service-3.png" alt="">
                    </div>
                    <div class="choose-content">
                        <h3>Scholarship Facility</h3>
                        <p>magna aliqua. Ut enim ad minim veniam conse ctetur adipisicing elit, sed do exercitation. </p>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="single-choose-us choose-bg-green">
                    <div class="choose-img">
                        <img class="animated" src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-img/service-4.png" alt="">
                    </div>
                    <div class="choose-content">
                        <h3>Scholarship Facility</h3>
                        <p>magna aliqua. Ut enim ad minim veniam conse ctetur adipisicing elit, sed do exercitation. </p>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="about-img default-overlay">
                    ...
                    <a class="video-btn video-popup" href="https://www.youtube.com/watch?v=sv5hK4crIRc">
                        <img class="animated" src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-img/video.png" alt="">
                    </a>
                </div>
            </div>
        </div>
...
<div class="course-area bg-img pt-130 pb-10" style="background-image:url(<?php echo get_template_directory_uri(); ?>/assets/img/bg/bg-1.jpg);">
    <div class="container">
        ...
        <div class="course-slider-active nav-style-1 owl-carousel">
            <div class="single-course">
                <div class="course-img">
                    <a href="course-details.html"><img class="animated" src="<?php echo get_template_directory_uri(); ?>/assets/img/course/course-1.jpg" alt=""></a>
            ...
            <div class="single-course">
                <div class="course-img">
                    <a href="course-details.html"><img class="animated" src="<?php echo get_template_directory_uri(); ?>/assets/img/course/course-2.jpg" alt=""></a>
                </div>
                <div class="course-content">
            ...
            <div class="single-course">
                <div class="course-img">
                    <a href="course-details.html"><img class="animated" src="<?php echo get_template_directory_uri(); ?>/assets/img/course/course-3.jpg" alt=""></a>
                </div>
                <div class="course-content">
            ...
            <div class="single-course">
                <div class="course-img">
                    <a href="course-details.html"><img class="animated" src="<?php echo get_template_directory_uri(); ?>/assets/img/course/course-4.jpg" alt=""></a>
        ...
        <div class="row">
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="single-count mb-30 count-one">
                    <div class="count-img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-img/achieve-1.png" alt="">
                    </div>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="single-count mb-30 count-two">
                    <div class="count-img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-img/achieve-2.png" alt="">
                    </div>
                    <div class="count-content">
            ...
            <div class="col-xl-4 col-lg-3 col-md-6 col-sm-6">
                <div class="single-count mb-30 count-three">
                    <div class="count-img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-img/achieve-3.png" alt="">
                    </div>
                    <div class="count-content">
            ...
            <div class="col-xl-2 col-lg-3 col-md-6 col-sm-6">
                <div class="single-count mb-30 count-four">
                    <div class="count-img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-img/achieve-4.png" alt="">
                    </div>
                    <div class="count-content">
        ...
        <div class="testimonial-slider-wrap mt-45">
            <div class="testimonial-text-slider">
                <div class="testi-content-wrap">
                    <div class="testi-big-img">
                        <img alt="" src="<?php echo get_template_directory_uri(); ?>/assets/img/testimonial/testi-b1.jpg">
                    </div>
                   <div class="row g-0">
                       <div class="ms-auto col-lg-6 col-md-12">
                           <div class="testi-content bg-img default-overlay" style="background-image:url(<?php echo get_template_directory_uri(); ?>/assets/img/bg/testi.png);">
                ...
                <div class="testi-content-wrap">
                   <div class="testi-big-img">
                        <img alt="" src="<?php echo get_template_directory_uri(); ?>/assets/img/testimonial/testi-b3.jpg">
                    </div>
                   <div class="row g-0">
                        <div class="ms-auto col-lg-6 col-md-12">
                           <div class="testi-content bg-img default-overlay" style="background-image:url(<?php echo get_template_directory_uri(); ?>/assets/img/bg/testi.png);">
                ...
                <div class="testi-content-wrap">
                    <div class="testi-big-img">
                        <img alt="" src="<?php echo get_template_directory_uri(); ?>/assets/img/testimonial/testi-b2.jpg">
                    </div>
                   <div class="row g-0">
                        <div class="ms-auto col-lg-6 col-md-12">
                           <div class="testi-content bg-img default-overlay" style="background-image:url(<?php echo get_template_directory_uri(); ?>/assets/img/bg/testi.png);">
            ...
            <div class="testimonial-image-slider">
                <div class="sin-testi-image">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/testimonial/testi-s2.jpg" alt="">
                </div>
                <div class="sin-testi-image">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/testimonial/testi-s1.jpg" alt="">
                </div>
                <div class="sin-testi-image">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/testimonial/testi-s3.jpg" alt="">
                </div>
                <div class="sin-testi-image">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/testimonial/testi-s3.jpg" alt="">
                </div>
        ...
        <div class="register-wrap">
            <div id="register-3" class="mouse-bg">
                <div class="winter-banner">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/banner/regi-1.png" alt="">
    ...
    <div class="container">
        ...
        <div class="custom-row">
            <div class="custom-col-5">
                <div class="single-teacher mb-30">
                    <div class="teacher-img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/teacher/teacher-1.jpg" alt="">
                    </div>
            ...
            <div class="custom-col-5">
                <div class="single-teacher mb-30">
                    <div class="teacher-img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/teacher/teacher-2.jpg" alt="">
                    </div>
                    <div class="teacher-content-visible">
                        <h4>Jui Khan</h4>
                        <h5>Lecturer</h5>
            ...
            <div class="custom-col-5">
                <div class="single-teacher mb-30">
                    <div class="teacher-img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/teacher/teacher-3.jpg" alt="">
                    </div>
                    <div class="teacher-content-visible">
                        <h4>Fawd Khan</h4>
                        <h5>Lecturer</h5>
            ...
            <div class="custom-col-5">
                <div class="single-teacher mb-30">
                    <div class="teacher-img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/teacher/teacher-4.jpg" alt="">
                    </div>
                    <div class="teacher-content-visible">
                        <h4>Fawd Khan</h4>
                        <h5>Lecturer</h5>
            ...
            <div class="custom-col-5">
                <div class="single-teacher mb-30">
                    <div class="teacher-img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/teacher/teacher-5.jpg" alt="">
                    </div>
                    <div class="teacher-content-visible">
                        <h4>Jui Khan</h4>
                        <h5>Lecturer</h5>
...
<div class="event-area bg-img default-overlay pt-130 pb-130" style="background-image:url(<?php echo get_template_directory_uri(); ?>/assets/img/bg/bg-3.jpg);">
    <div class="container">
        <div class="section-title mb-75">
        ...
        <div class="event-active owl-carousel nav-style-1">
            <div class="single-event event-white-bg">
                <div class="event-img">
                    <a href="event-details.html"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/event/event-1.jpg" alt=""></a>
            ...
            <div class="single-event event-white-bg">
                <div class="event-img">
                    <a href="event-details.html"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/event/event-2.jpg" alt=""></a>
                    <div class="event-date-wrap">
            ...
            <div class="single-event event-white-bg">
                <div class="event-img">
                    <a href="event-details.html"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/event/event-3.jpg" alt=""></a>
                    <div class="event-date-wrap">
                        <span class="event-date">1st</span>
                        <span>Dec</span>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="single-blog mb-30">
                    <div class="blog-img">
                        <a href="blog-details.html"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/blog/blog-1.jpg" alt=""></a>
                    </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="single-blog mb-30">
                    <div class="blog-img">
                        <a href="blog-details.html"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/blog/blog-2.jpg" alt=""></a>
                    </div>
                    <div class="blog-content-wrap">
                        <span>Education</span>
                        <div class="blog-content">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="single-blog mb-30">
                    <div class="blog-img">
                        <a href="blog-details.html"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/blog/blog-3.jpg" alt=""></a>
                    </div>
                    <div class="blog-content-wrap">
                        <span>Education</span>
                        <div class="blog-content">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="single-blog mb-30">
                    <div class="blog-img">
                        <a href="blog-details.html"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/blog/blog-4.jpg" alt=""></a>
                    </div>
                    <div class="blog-content-wrap">
                        <span>Education</span>
                        <div class="blog-content">
